...
- [d ]  A navigation bar with `About`, `Projects`, and `Contact` that link to the corresponding pages
- [ d]  Gallery of projects created with flexbox - you may use random images in place of project screenshots for now with the random image link: https://picsum.photos/ or you may use images that mean something to you
- [ ]d  Information about you in place of the given placeholder
- [ ]d  A `My Projects` button that links to the projects page
- [ ]d  A `Contact Me` button that links to the contact page
- [ ]d  Links to any social media profiles (Instagram, linkedIn, Twitter) into the footer section of your home page
