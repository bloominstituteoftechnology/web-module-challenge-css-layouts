...
- [ i dont use social media]  Links to any social media profiles (Instagram, linkedIn, Twitter) into the footer section of your home page
...
- [added a contact page ] Design and execute your own wireframe for `About`, `Projects`, and `Contact` pages
- [ https://nifty-tereshkova-5d8e4e.netlify.app/] Host your website on Netlify.com
