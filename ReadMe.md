...
- [ ] Clone your OWN version of the repository (Not Lambda's by mistake!). Got it!
...
- [ ]  Information about you in place of the given placeholder - ok
- [ ]  A `My Projects` button that links to the projects page - ok
- [ ]  A `Contact Me` button that links to the contact page - ok
