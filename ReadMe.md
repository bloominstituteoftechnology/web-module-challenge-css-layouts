...
- [1/2]  A `My Projects` button that links to the projects page
- [1/2]  A `Contact Me` button that links to the contact page
- [1/2]  Links to any social media profiles (Instagram, linkedIn, Twitter) into the footer section of your home page
